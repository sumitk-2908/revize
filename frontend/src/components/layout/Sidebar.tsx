...
export const SidebarNavigation = () => {
  const { sidebarCollapsed, pathname, pendingCount } = useSidebar();
      ...
      <>
        ...
        <div>
          ...
          <Link
            ...
            className={`motion-hover motion-active flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors ${pathname === '/'
          ...
          {isAdmin && (
            <Link
              ...
              className={`motion-hover motion-active mt-1 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors ${pathname === '/subject/admin/inbox'
        ...
        <div>
          ...
          {(isAdmin || isStudent) ? (
            <Link
              ...
              className={`motion-hover motion-active flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors ${pathname === '/continue-studying'
                ? 'bg-primary/10 text-primary'
                : 'text-muted hover:bg-surface-hover hover:text-primary'
                }`}
            >
          ...
          {(isAdmin || isStudent) ? (
            <Link
              ...
              className={`motion-hover motion-active mt-1 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors ${pathname === '/bookmarks'
                ? 'bg-warning/10 text-warning'
          ...
          <Link
            ...
            className={`motion-hover motion-active mt-1 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors ${pathname === '/recent-uploads'
          ...
          <Link
            ...
            className={`motion-hover motion-active mt-1 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors ${pathname === '/requests'
              ? 'bg-primary/10 text-primary'
              : 'text-muted hover:bg-surface-hover hover:text-primary'
              }`}
          >
...
export const Sidebar = () => {
  ...
  return (
    <aside aria-label="Main Desktop Navigation" className={`motion-sidebar sticky top-16 hidden h-[calc(100vh-4rem)] shrink-0 flex-col overflow-hidden border-r border-border bg-background lg:flex ${sidebarCollapsed ? 'w-16' : 'w-[220px]'}`}>
      <div className={`sidebar-scroll flex min-h-0 flex-1 flex-col overflow-y-auto py-6 ${sidebarCollapsed ? 'px-2' : 'px-4'}`}>
        <SidebarNavigation />
        <SidebarFooter />
      </div>
    </aside>
