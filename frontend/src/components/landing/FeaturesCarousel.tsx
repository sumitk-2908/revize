  ...
  const features = [
    {
      id: "01",
      title: "Upload & Share",
      description: "Upload missing notes or share materials seamlessly to help others.",
    ...
    },
    {
      ...
      description: "Request missing materials or upload notes to help the community.",
            ...
            return (
              ...
              >
                <motion.div
                  ...
                  className={`w-full max-w-[320px] rounded-[2rem] p-6 sm:p-8 transition-colors duration-500 border ${isActive
